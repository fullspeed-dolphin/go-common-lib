  ...
  <view class="pt30">
		...
		<section class="section-bottom">
			<view style="padding: 56rpx 54rpx 40rpx">
				...
				<view class="mt30">
					<u-button type="primary" shape="circle" color="#F2F2F2" textColor="#FF8C00" @click="unDevice()">解除绑定</u-button>
				</view>
			</view>
		</section>
...
font-size: 34rpx;">绑定说明</view>
				...
				<view class="flex-between-center btns" style="padding:40rpx;">
					<u-button type="primary" shape="circle" color="#F2F2F2" textColor="#707070" @click="bindDevice()">取消</u-button>

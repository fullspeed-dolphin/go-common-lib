<template>
	<view class="page">
		...
		<up-form ref="formRef" :model="form" :rules="formRules" labelWidth="150rpx">
			<view class="section">
			...
			<view class="section">
				...
				<view class="section-content">
					<up-form-item label="国家/地区" prop="country">
						<view class="" style="width:540rpx;margin: -20rpx;">
							<PickerCell v-model="form.country" :border="false" :columns="countryOptions" />
						</view>
					</up-form-item>
					<up-form-item label="省市区" prop="region" required>
						...
						<up-picker v-if="showProvincePicker" v-model="selectedProvince" :show="showProvincePicker" :columns="[provinceOptions]"
						...
						<up-picker  v-if="showCityPicker" v-model="selectedCity" :show="showCityPicker" :columns="[cityOptions]" :defaultIndex="cityIndex"
						...
						<up-picker v-if="showAreaPicker" v-model="selectedArea" :show="showAreaPicker" :columns="[areaOptions]" :defaultIndex="areaIndex"
							keyName="name" valueName="code" cancelText="取消" confirmText="确认" confirmColor="#FF8C00"
			...
			<view class="section">
				...
				<view class="section-content">
					...
					<up-form-item label1="衣服尺寸" prop="clothesSize" required>
						<view class="" style="width:495rpx;margin: -20rpx;">
							<PickerCell v-model="form.clothesSize" :border="false" :columns="tshirtSizeOptions" />
						</view>
						<template #label>
				...
				if (fullAddress) {
					...
					if (regionInfo) {
						...
						if (regionInfo.country) {
							...
							if (countryIdx !== -1) {
								form.value.country = regionInfo.country;
							}
						}

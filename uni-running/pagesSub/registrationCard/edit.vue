<template>
  <RegistrationCardForm v-model="form" mode="edit" :themeColor="themeColor" @submit="handleSubmit" />
</template>
...
function apiToForm(apiData) {
  ...
  // 处理cert_type：将后端枚举值转换为中文
  const certTypeReverseMap = {
    "CN_ID": "身份证",
    "HK_ID": "香港居民身份证",
    "MA_ID": "澳门居民身份证",

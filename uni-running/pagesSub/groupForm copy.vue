		...
		<view style="padding: 20rpx 34rpx">
			<up-form :model="form" ref="uForm" :rules="rules" labelPosition="top" labelWidth="auto">
				...
				<up-form-item label="跑团名称" prop="name" required>
					<input v-model="form.name" class="u-input" @change="() => uForm.validateField('name', () => {}, 'change')"  placeholder="请输入名称" />
				</up-form-item>
				<up-form-item label="跑团详情" prop="description" labelPosition="top" required>
					<textarea v-model="form.description" class="u-input" :height="110" maxlength="150" placeholder="请填写跑团详情" count></textarea>
				</up-form-item>
				...
				<up-form-item label="成立时间" prop="establish_time">
					<up-datetime-picker hasInput v-model="establishTimeTimestamp" mode="date" cancelText="取消" confirmText="确认"
						...
						<template #trigger="{ value }">
							<view class="select">
								<input :modelValue="value || ''" placeholder="请选择成立时间" class="u-input" readonly />
								<view class="arrow-right">
									<u-icon name="arrow-right" size="20" color="#707070" />
								</view>
							</view>
				...
				<up-form-item label="真实姓名" prop="fullName" required>
					<input v-model="form.fullName" class="u-input" placeholder="请输入您的真实姓名" />
				</up-form-item>
				<up-form-item label="联系电话" prop="phone" required>
					<input v-model="form.phone" class="u-input" placeholder="请输入您的联系电话" />
				</up-form-item>
			</up-form>

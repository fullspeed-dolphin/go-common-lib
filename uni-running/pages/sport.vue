        ...
        <view class="row u-flex-wrap u-flex-wrap u-flex-row" style="gap:20rpx;">
          <view class="section u-flex-1" style="min-width:45%;" @click="goToRanking">
            <view class="section-content">
              ...
              <image class="section-content-icon" style="width: 71rpx; height: 69rpx" src="https://ccrun.oss-cn-guangzhou.aliyuncs.com/weapp-static/images/icon-sport-top@2x.png" mode="aspectFill"></image>
            </view>
          </view>

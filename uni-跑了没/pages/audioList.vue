<template>
	<view class="index-page">
		<view class="section-search">
			<u-search placeholder="搜索" shape="square" bgColor="#fff8f4" placeholderColor="#d3b7b1" searchIconColor="#634942"
		...
		<mescroll-uni ref="mescrollRef" @init="mescrollInit" @down="downCallback" @up="getList" top="120rpx">
			<view class="" style="position:relative;z-index: 10;">
				...
				<SectionPanel title="音频作品" type="audio">
					<AudioItem v-for="(item, index) in dataList" :data="item" :key="index" />
				</SectionPanel>
			</view>
		</mescroll-uni>
		<tabbar type="audioList" />
	</view>
</template>
...
<style lang="less" scoped>
	.index-page {
		...
		&::before {
			...
			width: 100%;
			height: 390rpx;
			background: linear-gradient(#fde9e8, #fffcfc);
		}
	}
	...
	::v-deep {
		...
		.u-search {
			...
			&::before {
				...
				width: 100%;
				height: 120rpx;
				background: linear-gradient(#fde9e8, #feedec);
			}
